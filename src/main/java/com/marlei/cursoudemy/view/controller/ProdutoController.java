package com.marlei.cursoudemy.view.controller;
import java.util.List;
import java.util.Optional;
import java.util.stream.Collectors;
import com.marlei.cursoudemy.services.ProdutoService;
import com.marlei.cursoudemy.shared.ProdutoDTO;
import com.marlei.cursoudemy.view.model.ProdutoRequest;
import com.marlei.cursoudemy.view.model.ProdutoResponse;
...
public class ProdutoController {
    ...
    @GetMapping
    public ResponseEntity<List<ProdutoResponse>> obterTodos(){ //classe que sabe trabalhar com respostas diferentes e status cold diferentes
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deletar(@PathVariable Integer id){ // ? = qualquer coisa
